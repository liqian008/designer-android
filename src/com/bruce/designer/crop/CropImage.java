...
import com.bruce.designer.activity.Activity_CropAvatar;
...
//    		mProgress.show();
    	...
    	public void run()
    	{
    		...
    		mHandler.post(new Runnable() {
                public void run() {
                    try{
                    	mHandler.sendMessage(mHandler.obtainMessage(Activity_CropAvatar.SHOW_PROGRESS));
...
//    					}
    		...
    		{
    			mHandler.sendMessage(mHandler.obtainMessage(Activity_CropAvatar.REMOVE_PROGRESS));
//    			mHandler.post(new Runnable()
//    			{
//    				public void run()
//    				{
