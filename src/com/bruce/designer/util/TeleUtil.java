...
public class TeleUtil {
	 ...
	 */
	public static String getLine1Number(TelephonyManager tm) {// String
	 ...
	 */
	public static String getNetworkCountryIso(TelephonyManager tm) {// String
	 ...
	 * 在CDMA网络中结果也许不可靠。
	 */
	public static String getNetworkOperator(TelephonyManager tm) {// String
	 ...
	 * 在CDMA网络中结果也许不可靠。
	 */
	public static String getNetworkOperatorName(TelephonyManager tm) {// String
	 ...
	 */
	public static int getNetworkType(TelephonyManager tm) {// int
	 ...
	 */
	public static int getPhoneType(TelephonyManager tm) {// int
	 ...
	 */
	public static String getSimSerialNumber(TelephonyManager tm) {// String
	 ...
	 */
	public static String getVoiceMailNumber(TelephonyManager tm) {// String
