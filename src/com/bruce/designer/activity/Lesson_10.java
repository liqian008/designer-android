	...
	OnClickListener onclick = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.le10bt01:
				...
				// 设置通知在状态栏显示的图标
				baseNF.icon = R.drawable.logo_splash;
				...
				// 第四个参数：点击该通知时执行页面跳转
				baseNF.setLatestEventInfo(Lesson_10.this, "Title01",
						"Content01", pd);
			...
			case R.id.le10bt02:
				...
				baseNF.setLatestEventInfo(Lesson_10.this, "Title02",
						"Content02", pd);
				nm.notify(Notification_ID_BASE, baseNF);
				break;
			...
			case R.id.le10bt04:
				...
				mediaNF.icon = R.drawable.logo_splash;
				...
				mediaNF.setLatestEventInfo(Lesson_10.this, "Title03",
						"Content03", pd);
			...
			case R.id.le10bt07:
				...
				RemoteViews contentView = new RemoteViews(getPackageName(),
						R.layout.custom);
				contentView.setImageViewResource(R.id.image, R.drawable.logo_splash);
